...
export const FeedComponent = withStyles(styles)(function (props: Props): JSX.Element {
    const { feed, className, classes, isCommentsOpened, comments, commentsLoading, onCommentsToggle, onPayment, onCommentSend } = props;
    ...
    return (
        <Grid>
            <Accordion className={className} expanded={isCommentsOpened && !commentsLoading}>
                <AccordionSummary>
                            ...
                            <Grid xs={1}>
                                {
                                    commentsLoading && isCommentsOpened ?
                                        ...
                                        :
                                        (<IconButton size="small" onClick={() => onCommentsToggle(feed)} color={isCommentsOpened && 'primary' || undefined}><CommentIcon /></IconButton>)
                                }
                            </Grid>
                        </Grid>
                    </Grid>
